...
final class SignoffappUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Signoff Pro"].waitForExistence(timeout: 2))
    }
